...
function MissionContent() {
  return (
    <div className="flex relative flex-col gap-6 items-start self-stretch max-md:gap-8 max-sm:gap-6">
      <MissionTagline />
      <h1 className="relative self-stretch text-5xl font-bold tracking-tight leading-[56.4px] text-zinc-200 max-md:text-4xl max-md:leading-10 max-sm:text-3xl max-sm:leading-8 space-grotesk">
