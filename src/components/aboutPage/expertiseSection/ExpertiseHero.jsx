  ...
  return (
    <section className="flex flex-col justify-center items-center px-16 py-20 max-md:px-5">
      <div className="flex relative flex-col gap-10 items-center px-10 w-full max-w-[1306px] min-h-[495px] max-md:px-5 max-md:max-w-full bg-grad">
        <div className="flex relative flex-wrap gap-10 justify-between items-center self-stretch my-auto min-w-60 w-[1226px] max-md:w-[800px] max-sm:w-[219px] max-sm:flex-col max-sm:py-10">
          <img
            src={heroImage}
            className="object-contain self-stretch my-auto aspect-square min-w-60 w-[434px] max-md:max-w-full"
            alt="Francois - Paid Media Strategist"
          />
          <div className="flex flex-col self-stretch my-auto min-w-60 w-[712px] max-md:max-w-full max-sm:w-53">
            <HeroContent
              tagText={tagText}
              heading={heading}
