...
export const CaseStudyFooterContent = ({
  ...
  return (
    <div className="flex flex-col gap-5 items-center w-full max-sm:gap-4">
      <h1 className={`w-full text-5xl font-bold tracking-tight text-center leading-[56.4px] text-neutral-50 drop-shadow-xs drop-shadow-white max-md:text-4xl max-md:leading-10 max-sm:text-3xl max-sm:tracking-normal max-sm:leading-8 max-sm:drop-shadow-xs ${headingClassName}`}>
        {heading}
      </h1>
