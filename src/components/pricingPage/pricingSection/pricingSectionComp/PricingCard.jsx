        ...
        <section className="mt-8 w-full">
          <div className="flex flex-col justify-center w-full">
            ...
            <div className="mt-2 text-6xl font-bold tracking-normal leading-tight text-zinc-200 max-md:text-4xl max-sm:text-4xl">
              <span className="space-grotesk text-4xl drop-shadow-xs drop-shadow-white/40 leading-[67px] tracking-tight max-sm:text-4xl max-lg:text-3xl">
                {price}
              </span>
              <span className="space-grotesk text-4xl leading-[67px] tracking-tight max-sm:text-2xl max-lg:text-3xl">
                {period}
              </span>
            </div>
