...
const backgroundStyleExample = 'absolute left-[-24vw] bottom-[-58vh] w-[50vw] h-[50vw] rounded-full opacity-55 z-1 aspect-square'

export const BackgroundBlur = ({ backgroundStyle }) => {
  return (
    <div id='background-blur' className={backgroundStyle}
         style={{
