...
export const Header = ({ headerObj }) => {
  ...
  return (
    <header className={`flex overflow-y-visible relative flex-col justify-center items-center self-stretch min-h-[${headerObj.height}] h-auto py-16 lg:py-20 xl:py-24 max-lg:py-14 max-md:py-12 max-sm:py-10`}>
      <div className="flex relative flex-col gap-8 lg:gap-10 xl:gap-12 justify-center items-center self-stretch px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-0 flex-[1_0_0] z-2 max-w-7xl mx-auto w-full">
