...
export const Header = ({ headerObj }) => {
  ...
  return (
    <header className={`flex overflow-y-visible relative flex-col justify-center items-center self-stretch ${headerObj.height ? 'h-[calc(100vh-150px)]' : '' } max-sm:h-[calc(100vh-90px)] max-lg:h-[calc(100vh-70px)]`}>
