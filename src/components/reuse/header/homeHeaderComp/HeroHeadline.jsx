...
export const HeroHeadline = ({ headline, extHeadline, headingW }) => {
  return (
    <h1 className={`relative text-6xl text-center font-bold space-grotesk tracking-tight leading-[67.1px] text-neutral-50 w-[${headingW ? headingW : '1037px'}] max-md:w-full max-md:text-5xl max-md:tracking-tight max-sm:w-full max-sm:text-3xl max-sm:tracking-normal`}>
